...
class OCPEnableDeleteManager(AbstractJSONRequestManager):
    ...
    def get_error_message(self) -> str:
        return "Failed to enable delete of a cluster"
    ...
    def get_url(self) -> str:
        return OCPEnableDeleteManager._IBM_OCPPLUS_OCP_ENABLE_DELETE_PUT_URL.format(cluster_name=self._cluster_name)

    # override
    def is_request_id_to_be_ignored(self) -> bool:
        return True

    _IBM_OCPPLUS_OCP_ENABLE_DELETE_PUT_URL: Final[
        str
    ] = "https://ocpapi.svl.ibm.com/v1/ocp/{cluster_name}/enable_delete"
