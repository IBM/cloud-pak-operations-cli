...
def enable_delete(fyre_user_name: str, fyre_api_key: str, cluster_name: str, site: Optional[str]):
    """Enable erasability of an OCP+ cluster"""

    dg.utils.network.disable_insecure_request_warning()
    OCPPlusAPIManager(fyre_user_name, fyre_api_key).enable_delete(cluster_name, site)
