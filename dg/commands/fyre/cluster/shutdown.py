...
def shutdown(fyre_user_name: str, fyre_api_key: str, cluster_name: str, force: bool, site: Optional[str]):
    ...
    OCPPlusAPIManager(fyre_user_name, fyre_api_key).shutdown(cluster_name, site)
