...
from dg.lib.dependency_manager.dependency_manager import DependencyManager
...
from dg.lib.dependency_manager.plugins.terraform_plugin import TerraformPlugin
