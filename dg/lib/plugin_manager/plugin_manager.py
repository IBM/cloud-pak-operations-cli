...
from dg.lib.plugin_manager.distribution_entry_point_loader import (
    DistributionEntryPointLoader,
)
from dg.lib.plugin_manager.package_data import PackageData
...
class PluginManager:
    ...
    specifying one or more entry points within the dg_plugins group in their
    configuration file.
    ...
    def _load_plugins_if_required(self):
        ...
        selected_entry_points = entry_points().get("dg_plugins")
